...
cairo_pdf("ComplexHeatmap_ST3GAL3_expression_blood_cell_populations_55x2.pdf", width = 5.5, height =8)
print(myHeatmap)
dev.off()
drive_upload("ComplexHeatmap_ST3GAL3_expression_blood_cell_populations_55x8.pdf", path="~/ComplexHeatmap_ST3GAL3_expression_blood_cell_populations_55x8.pdf")
```
