---
title: "KSPZV1 edgeR DGE CSP-specific IgG Response, pre-immunization baseline transcriptomes"
author: "Tuan M. Tran"
date: "09/26/2021"
...
```{r, print plot of CSPAb data 2, echo=FALSE, fig.align='center', fig.width=3.75, fig.height=8.25, message=FALSE, warning=FALSE}
print(myPlot)
```

```{r, print plot of CSPAb data tp PDF, echo=FALSE, include=FALSE, fig.align='center', fig.width=4, fig.height=9, message=FALSE, warning=FALSE}
