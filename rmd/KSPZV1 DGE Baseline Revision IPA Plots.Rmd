...
myFiles <- list.files(path = datadir, pattern='*LFC 263 pval25 with logCSP SEX.xls')
...
cairo_pdf(paste0(figdir, "Fig 2E IPA UpReg 4 doses 1x4 revised logCSP SEX.pdf"), height = 6.5, width = 26)
myUpRegPlot
dev.off()
```