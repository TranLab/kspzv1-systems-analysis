...
# save(design, fit, degtab, file = "/Volumes/GoogleDrive/My Drive/Manuscripts/KSPZV1 Manuscript/Med Revised Submission 2022/Revision R Objects/Baseline Model All Treatments Batch Site log10 CSPAb baseline Pf_VAX1 adj.RData")
```
...
ggsave("/Volumes/GoogleDrive/My Drive/Manuscripts/KSPZV1 Manuscript/Med Revised Submission 2022/Figures/Fig S3ABC revised lowBTM HALLMARK BloodGen3 GSEA Bubble Plot.pdf", FigS3_plot, device = "pdf", units = "in", height = 8, width = 14.5)
```
