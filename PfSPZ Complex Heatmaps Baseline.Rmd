---
title: "PfSPZ Complex Heatmaps Baseline"
author: "Tuan M. Tran"
date: "09/08/2021"
...
col.hclust.method <- "pam" #ward.D2" #from ?hclust: This should be (an unambiguous abbreviation of) one of "ward.D", "ward.D2", "single", "complete", "average" (= UPGMA),"mcquitty" (= WPGMA), "median" (= #WPGMC) or "centroid" (= UPGMC). 
col.dist.method <- "euclidean" #"pearson" #pearson #spearman #euclidean #mahattan
row.hclust.method <- "pam" 
row.dist.method <- "euclidean" #"pearson" #pearson #spearman #euclidean #mahattan
PCT <- 100
...
#local
#CBCdat <- readxl::read_excel("/Volumes/GoogleDrive/My Drive/Tran Lab Shared/Projects/Doris Duke PfSPZ Kenya/Tuan PfSPZ/KenyaPfSPZ/CBC baseline with days before VAX1.xlsx")
#WeightDat <- read_csv("/Volumes/GoogleDrive/My Drive/Tran Lab Shared/Projects/Doris Duke PfSPZ Kenya/CDC PfSPZ Trial Results/KSPZV1_anthro_2021-04-12.csv")
...
#local
#source("/Volumes/GoogleDrive/My Drive/R scripts/Convert High Level BTM List into Long Tibble.R")
...
#As of 4/27/21, I have only written this for "allGroups", "delta" or Timepoint = 0, and noRowClust == 5
...
if(myGroup == "allGroups"){
  if(myTimepoint == 0){
    ...
    cl12.summarized <- cl12.summarized %>%
      ...
      #group_by(GeneSymbol) %>%
      #summarise(newRankMetric = median(newRankMetric)) %>%
      arrange(desc(newRankMetric))
